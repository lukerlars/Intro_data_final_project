...
def run(ticker, start_date = '2016-01-01'):
    ...
    # Plot mlp scenarios
    mlp_plot, ax = plt.subplots(figsize=(30, 20), nrows=len(mlp_scenarios))
    ...
    svm_plot, ax = plt.subplots(figsize=(30, 20), nrows=len(svm_scenarios))
